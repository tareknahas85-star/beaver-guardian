...
class ScreenshotCaptureService : Service() {
    ...
    private fun uploadScreenshot(bitmap: Bitmap) {
        ...
        val pairCode = Prefs.getPairCode(ctx) ?: return
        ...
        try {
            ...
            // Store under this device's pair-code node — same layout used
            // everywhere else in the app (CommandMessagingService, ScreenshotService).
