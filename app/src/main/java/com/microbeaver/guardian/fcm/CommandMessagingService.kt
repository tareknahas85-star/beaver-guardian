 ...
 *
 * NOTE: app/google-services.json currently points at a real-looking Firebase
 *       project ("beaver-guardian"), not the generic placeholder some older
 *       comments here implied. Confirm in the Firebase Console that this
 *       project is the one you intend to ship before relying on FCM/DB/Storage
 *       in production — this file was not modified as part of this pass.
 */
